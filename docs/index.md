...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/ntu168108/realtime-packet-sniff-v2/blob/main/LICENSE)
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/)
[![Platform: Linux](https://img.shields.io/badge/platform-Linux-lightgrey.svg)]()
[![Tests](https://img.shields.io/badge/tests-36%20passing-brightgreen.svg)](https://github.com/ntu168108/realtime-packet-sniff-v2/tree/main/tests/integration_tests)
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/ntu168108/realtime-packet-sniff-v2/blob/main/CHANGELOG.md)
...
UNSW-NB15 attack taxonomy with seven per-family feature filters and a
rule-based DoS scoring engine, and ships results to ClickHouse for
...
See [Deployment](operations/deployment.md) for the step-by-step Kafka,
ClickHouse, Grafana, Argus, Zeek, systemd, and troubleshooting guide.
Read [Architecture](operations/architecture.md) for the full data flow,
and the `deploy/` and `sql/` directories for ready-to-use configs.
...
See [`sniff-web/docs/WEB_GUI.md`](https://github.com/ntu168108/realtime-packet-sniff-v2/blob/main/sniff-web/docs/WEB_GUI.md) for full documentation. Quick start:
...
[MIT](https://github.com/ntu168108/realtime-packet-sniff-v2/blob/main/LICENSE) — see the `LICENSE` file.
