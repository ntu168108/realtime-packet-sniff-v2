...
Xem [Triển khai](operations/deployment.md) cho hướng dẫn từng bước về Kafka, ClickHouse, Grafana, Argus, Zeek, systemd, và xử lý sự cố. Đọc [Kiến trúc](operations/architecture.md) cho data flow đầy đủ, các thư mục `deploy/` và `sql/` cho config sẵn dùng.
...
├── config.yaml.example      # Config tham chiếu cho công cụ bắt gói tin
...
Xem [`sniff-web/docs/WEB_GUI.md`](https://github.com/ntu168108/realtime-packet-sniff-v2/blob/main/sniff-web/docs/WEB_GUI.md) để biết chi tiết. Cài nhanh:
...
[MIT](https://github.com/ntu168108/realtime-packet-sniff-v2/blob/main/LICENSE) — xem file `LICENSE`.
